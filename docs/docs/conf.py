...
# Social Media support for Plone build configuration file
...
html_theme_options = {
    ...
    "logo": {
        "text": "Social Media support for Plone",
    },
...
latex_documents = [
    (
        "index",
        "Social Media support for PloneDocumentation.tex",
        "Social Media support for Plone Documentation",
